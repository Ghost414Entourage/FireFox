// Generated Firefox hardening preferences
...
user_pref("privacy.panicButton.enabled", true);
user_pref("privacy.temporary_permission_expire_time_ms", 3600000);
user_pref("privacy.authPromptSpoofingProtection", true);
...
user_pref("network.cookie.block_nameless_with_equal_char", true);
...
user_pref("privacy.dynamic_firstparty.use_site", true);
user_pref("privacy.dynamic_firstparty.limitforeign", true);
